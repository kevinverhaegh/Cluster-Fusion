function output=ShockShellModel(rho, R0, Z, M, t, r0t)

N=trapz(r0t, 4.*rho.*pi.*r0t.^2);

disp('Amount of ions:')
disp(N)

densavg=Z*N/(4/3 * pi * R0^3) ; 

%t0=1/sqrt((10^27.*PhysConst.e^2)/(3.*PhysConst.AMU.*PhysConst.epsilon0));
...
Q=cumtrapz(r0t, 4*pi*Z.*rho.*r0t.^2)./(4/3 .* pi .* densavg .*R0.^3);
